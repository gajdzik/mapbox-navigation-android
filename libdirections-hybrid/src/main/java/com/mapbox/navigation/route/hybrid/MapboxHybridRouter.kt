...
class MapboxHybridRouter(
    ...
    private interface RouterDispatchInterface {
        fun execute(routeOptions: RouteOptionsNavigation, clientCallback: Router.Callback)
    }
    ...
    private class OnBoardRouterHandler(private val offRoute: Router, private val onboaredRouter: Router) : RouterDispatchInterface, Router.Callback {
        ...
        private var args: RouteOptionsNavigation? = null
        ...
        override fun execute(routeOptions: RouteOptionsNavigation, clientCallback: Router.Callback) {
            offrouterCalled = false
            args = routeOptions
